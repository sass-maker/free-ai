...
**Decision:** Keep it monolithic for now. Documented as a known trade-off in `agents.md` (repo map: "Hono app + all route handlers (monolithic — known TODO)") and gated in `STATUS.md` behind route-group test coverage.
