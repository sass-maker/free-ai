...
const DEFAULT_MODELS: ModelCandidate[] = [
  ...
  {
    id: 'command-code-claude-sonnet-4-6',
...
const DEFAULT_LIMITS: Record<string, ProviderLimitConfig> = {
 ...
 // AUTO-ADDED — tune
  ...
  // Command Code provider catalog expansion.
  'command_code:claude-sonnet-4-6': { requestsPerDay: 20 },
  'command_code:claude-fable-5': { requestsPerDay: 20 },
  'command_code:claude-opus-4-8': { requestsPerDay: 20 },
  'command_code:claude-opus-4-7': { requestsPerDay: 20 },
  'command_code:claude-haiku-4-5-20251001': { requestsPerDay: 20 },
  'command_code:gpt-5.5': { requestsPerDay: 20 },
  'command_code:gpt-5.4': { requestsPerDay: 20 },
  'command_code:gpt-5.3-codex': { requestsPerDay: 20 },
  'command_code:gpt-5.4-mini': { requestsPerDay: 20 },
  'command_code:moonshotai/Kimi-K2.6': { requestsPerDay: 20 },
  'command_code:moonshotai/Kimi-K2.5': { requestsPerDay: 20 },
  'command_code:zai-org/GLM-5.1': { requestsPerDay: 20 },
  'command_code:zai-org/GLM-5': { requestsPerDay: 20 },
  'command_code:MiniMaxAI/MiniMax-M3': { requestsPerDay: 20 },
  'command_code:MiniMaxAI/MiniMax-M2.7': { requestsPerDay: 20 },
  'command_code:MiniMaxAI/MiniMax-M2.5': { requestsPerDay: 20 },
  'command_code:deepseek/deepseek-v4-pro': { requestsPerDay: 20 },
  'command_code:deepseek/deepseek-v4-flash': { requestsPerDay: 20 },
  'command_code:Qwen/Qwen3.6-Max-Preview': { requestsPerDay: 20 },
  'command_code:Qwen/Qwen3.6-Plus': { requestsPerDay: 20 },
  'command_code:Qwen/Qwen3.7-Max': { requestsPerDay: 20 },
  'command_code:Qwen/Qwen3.7-Plus': { requestsPerDay: 20 },
  'command_code:stepfun/Step-3.7-Flash': { requestsPerDay: 20 },
  'command_code:stepfun/Step-3.5-Flash': { requestsPerDay: 20 },
  'command_code:xiaomi/mimo-v2.5-pro': { requestsPerDay: 40 },
  'command_code:xiaomi/mimo-v2.5': { requestsPerDay: 50 },
...
function hasProviderKey(env: Env, provider: TextProvider): boolean {
  switch (provider) {
    ...
    case 'command_code':
      return Boolean(env.COMMAND_CODE_API_KEY);
    default:
      return false;
  }
}
