...
| Marketing / docs site | Astro homepage plus Blume API docs at `/docs/`, built into `site/dist` and served by the Worker via the `ASSETS` binding — no separate deploy |
